...
const BedIcon = (p) => (
  <Icon
    {...p}
    path="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8M2 10V6a2 2 0 0 1 2-2h4M6 10V4M18 10V4M2 16h20"
  />
);
const ClockIcon = (p) => (
  <Icon {...p} path="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2zM12 6v6l4 2" />
);
  ...
  if (items.length === 0) {
    return (
      <div className="ls-empty-state">
        ...
        <button className="ls-empty-clear-btn" onClick={onClearFilters}>
          Clear all filters
        </button>
      </div>
    );
          ...
          <div className="ls-card-inner">
            ...
            <div className="ls-card-video">
              ...
              <div className="ls-badges">
                {item.primaryBadge && (
                  <span className="ls-badge-super">
                    <AwardIcon size={9} /> {item.primaryBadge}
                  </span>
                )}
                {item.bookedRecently && (
              ...
              <div className="ls-availability">
                <span
                  className={`ls-availability-dot-large ${!item.availability ? "busy" : ""}`}
                />
            ...
            <div className="ls-card-content">
              ...
              <div className="ls-rating">
                ...
                <span className="ls-rating-value">
                  {item.rating}{" "}
                  <span className="ls-rating-count">({item.reviews})</span>
                </span>
              </div>
              ...
              <div className="ls-response-time">
                ...
                <div className="ls-actions">
                  <button className="ls-message-btn">
                    <MsgIcon size={12} /> {item.enquireLabel}
                  </button>
                  <button className="ls-book-btn">
                    {item.bookLabel} <ChevronRightIcon size={11} />
                  </button>
                </div>
              </div>
            </div>
...
export default function LifeSync() {
  ...
  const clearNurseFilters = () => {
    setNurseSearch("");
    setShiftFilter("all");
    setNurseAvailNow(false);
    setMaxPrice(100);
    setNurseSortBy("recommended");
  };
  const hasNurseFilters =
    nurseSearch ||
    shiftFilter !== "all" ||
    nurseAvailNow ||
    maxPrice < 100 ||
    nurseSortBy !== "recommended";

  // ── Filtered hospitals ──
  const hospSpecialties = [
    "all",
    ...new Set(HOSPITALS.map((h) => h.specialty)),
  ];
  ...
  const clearHospFilters = () => {
    setHospSearch("");
    setHospType("all");
    setHospSpecialty("all");
    setHospAvailNow(false);
    setHospEmergency(false);
    setMaxDistance(20);
    setHospSortBy("recommended");
  };
  const hasHospFilters =
    hospSearch ||
    hospType !== "all" ||
    hospSpecialty !== "all" ||
    hospAvailNow ||
  ...
  function SearchSection({
    ...
    return (
      <div className="ls-search-section">
        ...
        {/* Quick filter tabs */}
        <div className="ls-filter-tabs">{quickTabs}</div>
        ...
        {showFilters && (
          <div className="ls-advanced-filters">
            ...
            <div className="ls-filter-grid">{advancedFilters}</div>
          </div>
        )}
        ...
        <div className="ls-results">
          <p className="ls-results-count">
            <span className="ls-results-number">{resultCount}</span>{" "}
            {resultLabel} found
          </p>
          {hasFilters && (
      ...
      <header className="ls-header">
        <div className="ls-header-content">
          ...
          <p className="ls-subtitle">
            Find verified nurses and partner hospitals for stroke care — all in
            one place
          </p>
        </div>
      </header>
      ...
      <div className="ls-main">
        ...
        {mode === "emergency" && (
          <div className="ls-emergency-panel">
            {/* FAST Warning Signs Section - Using warning-signs style */}
            <div className="warning-signs" style={{ padding: "60px 0 40px 0" }}>
              <div className="container">
                <h2>Stroke Warning Signs - FAST</h2>
                <p className="warning-subtitle">
                  Know the signs. Every minute counts.
                </p>
            ...
            <div className="ls-emergency-card">
              ...
              <div className="ls-emergency-contacts">
                {[
                  ...
                  {
                    name: "Calmette Hospital Emergency",
        ...
        {mode === "hospital" && (
          <SearchSection
            search={hospSearch}
            setSearch={setHospSearch}
            showFilters={showHospFilters}
            setShowFilters={setShowHospFilters}
            hasFilters={hasHospFilters}
            onClearFilters={clearHospFilters}
            ...
            quickTabs={
              <>
                ...
                >
                  <span
                    className={`ls-availability-dot-small ${hospAvailNow ? "active" : ""}`}
                  />
                  Open Now
                </button>
                <button
                ...
                >
                  <span
                    className={`ls-availability-dot-small ${hospEmergency ? "active" : ""}`}
                  />
                  24/7 Emergency
                </button>
              </>
              ...
              <>
                <div className="ls-filter-group">
                  ...
                  <select
                    className="ls-select"
                    value={hospSortBy}
                    onChange={(e) => setHospSortBy(e.target.value)}
                  >
                ...
                <div className="ls-filter-group">
                  ...
                  <select
                    className="ls-select"
                    value={hospSpecialty}
                    onChange={(e) => setHospSpecialty(e.target.value)}
                  >
        ...
        {mode === "nurses" && (
          <SearchSection
            ...
            showFilters={showNurseFilters}
            setShowFilters={setShowNurseFilters}
            ...
            quickTabs={
              <>
                ...
                >
                  <span
                    className={`ls-availability-dot-small ${nurseAvailNow ? "active" : ""}`}
                  />
                  Available Now
                </button>
              </>
