...
const Home = () => {
  const stats = [
    ...
    { value: "five", label: "Hospitals Engaged", icon: <FaShieldAlt /> },
  ];
        ...
        <div className="home-page-hero-left">
          <div className="home-page-hero-content">
            ...
            <p className="home-page-hero-subtitle">
              Experience the future of healthcare with AI-powered symptom
              analysis and personalized wellness guidance.
            </p>
          </div>
        ...
        <div className="home-page-features-grid">
          {features.map((f, i) => (
            <div key={i} className="home-page-feature-card">
              ...
              <Link to={f.link} className="home-page-feature-link">
